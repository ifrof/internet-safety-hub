...
const ar: Record<string, string> = {
  ...
  'howItWorks.step1.desc': 'استخدم البحث المتقدم أو تصفح الفئات للعثور على المصنع المناسب',
...
const en: Record<string, string> = {
  ...
  'howItWorks.step1.desc': 'Use advanced search or browse categories to find the right factory',
...
const zh: Record<string, string> = {
  ...
  'howItWorks.step1.desc': '使用高级搜索或浏览类别找到合适的工厂',

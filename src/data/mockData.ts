...
export const []: Factory[] = [
  ...
  },
  {
    ...
    manufacturingTypes: ['OEM', 'Private Label'],
    verificationStatus: 'verified',
  ...
  },
  {
    ...
    manufacturingTypes: ['OEM', 'ODM', 'Private Label'],
    verificationStatus: 'verified',
  ...
  },
  {
    ...
    manufacturingTypes: ['ODM', 'Private Label'],
    verificationStatus: 'verified',
...
export const subscriptionPlans: SubscriptionPlan[] = [
  {
    ...
    interval: 'monthly',
    features: [
      'عملية بحث واحدة عن مصنع فقط',
      'الوصول لسوق المصانع',
      'التواصل مع مصنع واحد فقط',
      'دعم أساسي عبر المنصة',
      'صلاحية شهر واحد',
    ],
    maxOrders: 1,
  ...
  },
  {
    ...
    interval: 'monthly',
    features: [
      '15 عملية بحث عن مصانع',
      'الوصول لسوق المصانع',
      'التواصل مع 15 مصنع',
      '10 طلبات استيراد شهرياً',
      'دعم متقدم عبر المنصة',
      'خصم 5% على خدمات الفحص',
    ],
    maxOrders: 10,
    maxFactoryContacts: 15,
    aiSearches: 15,
    priority: false,
  },
  {

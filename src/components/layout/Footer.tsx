...
const Footer = forwardRef<HTMLElement>((_, ref) => {
  ...
  return (
    <footer ref={ref} className="bg-accent text-white">
      {/* Main Footer */}
        ...
        <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-5 gap-8 md:gap-12">
          ...
          <div className="sm:col-span-2">
            ...
            <div className="flex gap-3">
              <a href="#" className="w-9 h-9 md:w-10 md:h-10 rounded-lg bg-white/10 flex items-center justify-center hover:bg-primary transition-colors">
          ...
          <div>
            ...
            <ul className="space-y-3 md:space-y-4">
              <li className="flex items-center gap-3">
                ...
                <span className="text-white/70 text-sm md:text-base">support@ifrof.com</span>
              </li>
              <li className="flex items-center gap-3">
                <div className="w-9 h-9 md:w-10 md:h-10 rounded-lg bg-white/10 flex items-center justify-center">
                  <Phone className="w-4 h-4 md:w-5 md:h-5 text-primary" />
                </div>
                <span className="text-white/70 text-sm md:text-base" dir="ltr">+86 123 456 7890</span>
              </li>
              <li className="flex items-center gap-3">
                <div className="w-9 h-9 md:w-10 md:h-10 rounded-lg bg-white/10 flex items-center justify-center">
